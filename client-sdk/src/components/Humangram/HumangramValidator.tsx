...
function HumangramValidator({onProof, websocket}: HumangramValidator) {
  ...
  return (
    <>
    <button onClick={() => setOpen(true)} type="button" className="text-zinc-100 bg-[#29A9EA] hover:bg-[#29A9EA]/90 focus:ring-4 focus:outline-none focus:ring-[#9152FF]/70 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center shadow-sm shadow-[#202020]/50 transition-all duration-100 dark:focus:ring-[#9152FF]/70">
