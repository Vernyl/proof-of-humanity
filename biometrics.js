 ...
 * @param {string} biometricsProof - The Biometrics proof that verifies the success of the human verification.
 * @returns {Promise<object|null>} - The generated validator signed proof object, or null if the human verification fails.
 */
async function generateProof(data, biometricsProof) {
